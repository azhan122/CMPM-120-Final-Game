class Title extends Phaser.Scene {
    ...
    create() {
        ...
        my.text.title = this.add.bitmapText(game.config.width/3, 100, "rocketSquare", "Gravitator");
        my.text.desc1 = this.add.bitmapText(game.config.width/3 - 15, 135, "rocketSquare", "E to activate artifact").setScale(0.55);
        my.text.desc2 = this.add.bitmapText(game.config.width/3 - 30, 160, "rocketSquare", "Q to deactivate artifact").setScale(0.55);
        my.text.desc3 = this.add.bitmapText(game.config.width/3 + 40, 185, "rocketSquare", "Press P to play").setScale(0.5);
        ...
        my.sprite.player = this.physics.add.sprite(50, 14 * 18, "tilemap_sheet", 0).setScale(1.0);
